...
class TourAgent:
    ...
    _AGENTIC_MAP_SYSTEM = (
        ...
        "  A rich file can and should contribute 2-4 separate concepts.\n"
        "  Test: 'Can I explain this in 3 sentences without mentioning the other concepts\n"
        "  from the same file?' If yes — it is a separate concept worth its own entry.\n\n"
        "NAMING RULES:\n"
